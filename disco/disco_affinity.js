  ...
  //  Update graph with current nodes and edges
{
  ...
  graph.node = [
    ...
    { ID:"@grape", group:1, index:2,name:"grape", px:200, py:200, size:3, weight:100, x:250, y:150}
  ];
  graph.edge = [
    { 
      source: 1, 
  ...
  force = d3.layout.force()   // Create force graph
    .nodes( graph_nodes )    //  Link to node list
    .links( graph_links )    //  Link to edge list
    .charge( -120 )
    .linkDistance( 100 )
  ...
  //n_list = n_list.data( test_nodes );
  //l_list = l_list.data( test_links );
  ...
  //  Initialize d3 force-directed graph object
{
  ...
  /*
  graph.node = [
    { ID:"@apple", group:1, index:0,name:"apple", px:31, py:85, size:40, weight:2, x:41, y:95},
    { ID:"@orange", group:1, index:1,name:"orange", px:180, py:200, size:10, weight:5, x:200, y:300},
    { ID:"@grape", group:1, index:1,name:"grape", px:200, py:120, size:3, weight:1, x:250, y:150}
  ];
  graph.edge = [
    { 
      source: { ID:"@apple", group:1, index:0,name:"apple", px:31, py:85, size:40, weight:2, x:41, y:95}, 
      target: { ID:"@orange", group:1, index:1,name:"orange", px:180, py:200, size:10, weight:5, x:200, y:300},
      value:1
    },
    { 
      source: { ID:"@grape", group:1, index:1,name:"grape", px:200, py:120, size:3, weight:1, x:250, y:150},
      target: { ID:"@orange", group:1, index:1,name:"orange", px:180, py:200, size:10, weight:5, x:200, y:300},
      value:1
    }
  ];*/
