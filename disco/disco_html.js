...
//  Stub out console.log() calls, if the function doesn't exist (IE!)
  ...
  $("#query-btn").click( function() {
    ...
    if ( $("#query-inp").val() == "fb" ) {
      ...
      //disco_main( document.getElementById( "query-inp" ).value, 15 );
      disco_main( "test", 15 );
    }
  });
  */
  ...
  var btn = document.getElementById("file_upload_btn");
  ...
  function showDialog(){
    $("#dialog-page").load('/open_upload_page').dialog({
        autoOpen: false,
        resizable: true,
        height: 500,
        width: 800,
  ...
  */
  ...
  button.download = "disco_screenshot.png";
...
*/
  ...
  // Jianbo: error in init_narrative() and init_tw_list, commented out for now
  ...
  // generate visualization given the file name
  disco_main();
});
